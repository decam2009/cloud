...
public class AuthorizationController {
    ...
    public ResponseEntity<Token> login(@AuthenticationPrincipal @RequestBody Credential credential) {
        ...
        Token token = Token.builder()
                .value(userAuthenticationProvider.createToken(credential.getLogin()))
                .build();
